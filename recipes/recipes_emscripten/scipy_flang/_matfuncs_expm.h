...
int cgetrf_(int* m, int* n, EXPM_C* a, int* lda, int* ipiv, int* info);
int cgetrs_(char* trans, int* n, int* nrhs, EXPM_C* a, int* lda, int* ipiv, EXPM_C* b, int* ldb, int* info);
...
int zgetrf_(int* m, int* n, EXPM_Z* a, int* lda, int* ipiv, int* info);
int zgetrs_(char* trans, int* n, int* nrhs, EXPM_Z* a, int* lda, int* ipiv, EXPM_Z* b, int* ldb, int* info);

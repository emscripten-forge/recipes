"""Run pytester with a Playwright timeout long enough for numpy-tests."""
import os

from playwright.async_api import Page

# pyjs_code_runner hardcodes 4 minutes, which is too short for NumPy's full suite.
_TIMEOUT_MS = int(os.environ.get("PYTESTER_TIMEOUT_MIN", "10")) * 60 * 1000

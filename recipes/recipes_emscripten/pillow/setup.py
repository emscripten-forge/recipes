...
class pil_build_ext(build_ext):
    ...
    def build_extensions(self):
        ...
        if True and self.disable_platform_guessing:
            pass
        ...
        # standard locations
        if False and not self.disable_platform_guessing:
        ...
        if False and feature.want("jpeg"):
            ...
            if _find_include_file(self, "jpeglib.h"):
                ...
                raise RuntimeError("jpeglib.h not found")
        feature.jpeg = "jpeg"
        ...
        if False and feature.want("freetype"):

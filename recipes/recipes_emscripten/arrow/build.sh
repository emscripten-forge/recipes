...
ARROW_FEATURES="$ARROW_FEATURES -DARROW_JEMALLOC=OFF"
ARROW_FEATURES="$ARROW_FEATURES -DARROW_ENABLE_THREADING=OFF"
ARROW_FEATURES="$ARROW_FEATURES -DARROW_WITH_OPENTELEMETRY=OFF"
# Enable features
...
ARROW_FEATURES="$ARROW_FEATURES -DARROW_WITH_BZ2=ON"
ARROW_FEATURES="$ARROW_FEATURES -DARROW_WITH_LZ4=ON"
ARROW_FEATURES="$ARROW_FEATURES -DARROW_WITH_ZLIB=ON"
ARROW_FEATURES="$ARROW_FEATURES -DARROW_WITH_ZSTD=ON"
...
ARROW_FEATURES="$ARROW_FEATURES BOOST_ROOT=$PREFIX"
ARROW_FEATURES="$ARROW_FEATURES -DARROW_WITH_BOOST=OFF"
ARROW_FEATURES="$ARROW_FEATURES -DARROW_SUBSTRAIT=ON"

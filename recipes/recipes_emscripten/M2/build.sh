...
emcmake cmake -S ../.. -B . \
      ...
      -DCMAKE_EXE_LINKER_FLAGS="-s ALLOW_MEMORY_GROWTH=1 -s NODERAWFS=1 -L$PREFIX/lib -ldummy_pthread -s TOTAL_STACK=32MB -s INITIAL_MEMORY=512MB -s MAXIMUM_MEMORY=4GB -s FORCE_FILESYSTEM=1" \
      -DWITH_PYTHON=OFF \

...
When an incident does occur, it is important to report it promptly. To report a possible violation please contact us via report@quantstack.net.
...
Access to all community spaces, tools, and communication channels is removed. In general, permanent bans should be used rarely, should have strong reasoning behind them, and should only be resorted to if other remedies have failed to change the behavior.

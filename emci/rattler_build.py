...
def build_with_rattler(recipe=None, recipes_dir=None, emscripten_wasm32=False, n_retry=0):
    ...
    @retry(tries=n_retry)
    def build_with_rattler_impl(recipe, recipes_dir, emscripten_wasm32):
    ...
    build_with_rattler_impl(recipe=recipe, recipes_dir=recipes_dir, emscripten_wasm32=emscripten_wasm32)
